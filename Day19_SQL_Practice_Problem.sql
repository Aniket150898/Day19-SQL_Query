...
('Aniket', '484949402', '12z Jaihind Nagar'),
('Sky', '989456789', '10y Bharat Nagar'),
('Sonic', '9898838210', '25x Jawahar Nagar');
...
UPDATE Customer SET Country='USA', Salary=55000.00, Pincode='424001' WHERE CustomerName='Aniket';
UPDATE Customer SET Country='Canada', Salary=66000.00, Pincode='456001' WHERE CustomerName='Sky';
UPDATE Customer SET Country='India', Salary=44000.00, Pincode='520140' WHERE CustomerName='Sonic';

//*5) Update customer details based on customer name.*/
UPDATE Customer SET Country='UAE', Salary=35000.00, Pincode='424002' WHERE CustomerName='Aniket';
